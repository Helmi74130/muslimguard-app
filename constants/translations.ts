...
export const translations = {
  ...
  settings: {
    ...
    about: {
      ...
      privacyDescription: 'Toutes vos données restent sur votre appareil. Aucune collecte, aucun serveur, aucune publicité. Ce que votre enfant fait sur son téléphone ne regarde que vous.',
      support: 'Support',
      whoWeAre: 'Qui sommes-nous ?',
      whoWeAreText: 'MuslimGuard est né d\'une conviction simple : nos enfants méritent mieux qu\'internet sans garde-fou.\n\nNous sommes une équipe de musulmans, sur la voie des pieux prédécesseurs (السلف الصالح). Des parents, comme vous, qui ont vu leurs enfants exposés au haram, au shirk, à la musique, aux images indécentes — souvent sans même le savoir.\n\nAlors nous avons décidé d\'agir.',
      ourMission: 'Notre mission',
      ourMissionText: 'Protéger nos enfants du contenu numérique haram : sites obscènes, musique, contenus violents, propagande contraire à l\'Islam.\n\nLes histoires, jeux et vidéos proposés dans l\'app sont vérifiés et sélectionnés : sans shirk, sans musique, sans obscénité. Un espace pensé pour que votre enfant s\'amuse et apprenne en toute quiétude.\n\nMuslimGuard veut aussi renforcer le lien entre le parent et l\'enfant — pas seulement filtrer, mais créer ensemble de bons moments.',
      ourCommitment: 'Un outil, pas un substitut',
      ourCommitmentText: 'MuslimGuard est un outil d\'aide — il ne remplace pas votre présence, votre éducation, ni votre du\'a pour vos enfants.\n\nInternet reste complexe et nous ne pouvons pas prétendre tout contrôler à 100%. Certains contenus peuvent passer. L\'app est là pour réduire les risques, pas pour vous donner fausse confiance.\n\nLe vrai bouclier, c\'est vous.',
      reviewEncouragement: 'Votre avis compte',
      reviewEncouragementText: 'Nous ne faisons pas de publicité. Nous n\'avons pas d\'investisseurs. Notre seule visibilité, c\'est le bouche-à-oreille et les avis sur le store.\n\nChaque étoile que vous laissez aide d\'autres familles musulmanes à nous trouver. Des parents qui cherchent exactement ce que vous avez trouvé ici.\n\nCela prend 30 secondes. Barak Allahu fikum.',
    },
    reset: {
