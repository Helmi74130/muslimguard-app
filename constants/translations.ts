...
export const translations = {
  ...
  blocklist: {
    ...
    // Categories section
    categories: {
      title: 'Catégories de blocage',
      subtitle: 'Activez ou désactivez les catégories de contenus bloqués',
      sites: 'sites',
      keywords: 'mots-clés',
      enabled: 'Activé',
      disabled: 'Désactivé',
      disableWarning: 'Êtes-vous sûr de vouloir désactiver cette catégorie ? Les contenus de type "{category}" ne seront plus bloqués.',
    },
    // Custom items section
    custom: {
      title: 'Mes ajouts personnalisés',
      subtitle: 'Sites et mots-clés que vous avez ajoutés manuellement',
      domainsTab: 'Sites',
      keywordsTab: 'Mots-clés',
      addDomain: 'Ajouter un site à bloquer',
      addKeyword: 'Ajouter un mot-clé à bloquer',
      domainPlaceholder: 'exemple.com',
      keywordPlaceholder: 'mot-clé',
      emptyDomains: 'Aucun site ajouté manuellement',
      emptyKeywords: 'Aucun mot-clé ajouté manuellement',
      emptyDescription: 'Les catégories ci-dessus bloquent déjà des centaines de sites et mots-clés. Ajoutez ici vos propres règles supplémentaires.',
      addDomainSuccess: 'Site ajouté',
      addKeywordSuccess: 'Mot-clé ajouté',
      deleteConfirm: 'Voulez-vous retirer cet élément ?',
    },
    ...
    resetConfirm: 'Voulez-vous réinitialiser toutes les catégories et supprimer vos ajouts personnalisés ?',
  },
  ...
  videos: {
    ...
    noFavoritesDesc: 'Appuie sur le ❤️ pour ajouter des vidéos à tes favoris.',
    noCustomVideos: 'Aucune vidéo personnalisée',
    noCustomVideosDesc: 'Demande à tes parents d\'ajouter des vidéos.',
  ...
  // Custom videos management (parent)
  customVideos: {
    title: 'Mes Vidéos Personnalisées',
    subtitle: 'Ajoutez vos propres vidéos YouTube',
    addVideo: 'Ajouter une vidéo',
    urlPlaceholder: 'URL YouTube ou ID vidéo',
    urlHint: 'Exemple: https://youtube.com/watch?v=...',
    add: 'Ajouter',
    cancel: 'Annuler',
    myVideos: 'Mes vidéos',
    noVideos: 'Aucune vidéo ajoutée',
    noVideosDesc: 'Ajoutez des vidéos YouTube éducatives pour vos enfants.',
    deleteConfirm: 'Supprimer cette vidéo ?',
    deleteConfirmDesc: 'Cette action est irréversible.',
    delete: 'Supprimer',
    errors: {
      invalidUrl: 'URL YouTube invalide',
      invalidUrlDesc: 'Veuillez entrer une URL YouTube valide.',
      duplicate: 'Vidéo déjà ajoutée',
      duplicateDesc: 'Cette vidéo existe déjà dans votre liste.',
      limitReached: 'Limite atteinte',
      limitReachedDesc: 'Vous avez atteint la limite de 999 vidéos.',
      fetchFailed: 'Impossible de récupérer les informations',
      fetchFailedDesc: 'Vérifiez votre connexion et réessayez.',
    },
    success: {
      added: 'Vidéo ajoutée',
      addedDesc: 'La vidéo a été ajoutée avec succès.',
      deleted: 'Vidéo supprimée',
      deletedDesc: 'La vidéo a été supprimée.',
    },
  },
